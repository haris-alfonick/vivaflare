...
export default function TheCall() {
  return (
    <>
      <section className="relative bg-[url('/images/thecallbanner.webp')] bg-cover bg-center 2xl:h-[calc(100vh_-_169px)] h-[calc(100vh_-_152px)] max-md:h-[calc(100vh_-_172px)]">
