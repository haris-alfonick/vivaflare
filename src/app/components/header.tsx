...
export default function Header() {
  ...
  return (
    <header className="bg-[#000000] text-white max-sm:px-2 px-6 py-4 space-x-4 flex items-center justify-between">
      ...
      <div className="headerSearch relative mr-0 flex align-middle w-[50%] max-w-[50%] [&_input]:w-full [&_input]:px-10 [&_input]:py-3 rounded-full pr-6 max-sm:pr-4 bg-[#1D1A24] [&_input]:text-white [&_input]:text-sm max-sm:[&_input]:pl-3 max-sm:[&_input]:pr-6 max-sm:[&_input]:py-[8px] [&_input]:placeholder-[#A6A6A6] [&_input]:focus:outline-none [&_svg]:w-5 max-sm:[&_svg]:w-4 max-sm:[&_svg]:pt-[9px] [&_svg]:pt-[11px] [&_svg]:text-[#A6A6A6]">
        <input
          type="text"
