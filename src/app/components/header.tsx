...
export default function Header() {
    ...
    return (
      <header className="bg-[#000000] text-white px-6 py-4 space-x-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 [&_button]:hover:cursor-pointer [&_svg]:w-6 [&_button]:inter [&_button]:px-6 [&_button]:sm:block [&_button]:transition-all [&_button]:text-white [&_button]:font-semibold [&_button]:text-sm [&_button]:py-3 [&_button]:rounded-full">
