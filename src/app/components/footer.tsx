...
export default function Footer() {
    ...
    return (
      <footer className="bg-[#000000] md:flex-row flex-col text-white px-6 py-6 gap-4 flex items-center justify-between">
        <div>
          <Image
          ...
          />
            ...
            <ul className="flex whitespace-nowrap align-middle space-x-4">
        ...
        <div className="flex items-center space-x-3 [&_svg]:w-[37px] [&_svg]:text-[#000000] [&_svg]:py-[7px] [&_svg]:bg-white [&_svg]:rounded-full [&_svg]:h-[36px]">
