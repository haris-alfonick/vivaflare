...
export default function Welcome() {
    return (
        <section className="relative h-full bg-[#14121B] scrollbar 2xl:overflow-hidden! m-7 mb-0! rounded-tl-[30px] rounded-tr-[30px]">
            <div className="text-white text-center absolute top-0 right-0 w-fit m-auto 2xl:h-fit h-[100%] bottom-0 left-0 sm:px-0 px-4 [&_h2]:2xl:text-[42px] sm:[&_p]:w-[630px] [&_p]:mx-auto [&_p]:w-[100%] [&_h2]:md:text-[32px] [&_h2]:text-[25px] [&_h2]:font-bold [&_p]:text-sm [&_p]:2xl:text-[16px]">
                ...
                <Carousel className="pt-5">
                    <CarouselContent>
                        <CarouselItem className="basis-1/2 md:basis-[26.3%]"> <Image
