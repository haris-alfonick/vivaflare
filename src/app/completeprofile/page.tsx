    ...
    return (
        <section className="relative h-full pt-[22px] px-[25px] pb-0">
            <div className="bg-[#14121B] h-full rounded-tl-[30px] rounded-tr-[30px]">
                <div className="text-white max-md:px-[35px] [&_h2]:mt-4 text-center absolute top-0 right-0 w-fit max-md:m-auto mx-auto mt-6 md:h-full h-fit bottom-0 left-0 px-0 [&_h2]:2xl:text-[42px] sm:[&_h2]:w-[549px] [&_h2]:w-[100%] [&_h2]:md:text-[32px] [&_h2]:text-[25px] [&_h2]:font-bold [&_p]:text-sm [&_p]:2xl:text-[16px]">
                    ...
                    <Link href="/completeage"><button className="bg-[#F80C5B] hover:bg-[#7238fd] transition-all text-sm absolute left-0 right-0 bottom-[60px] max-md:bottom-[-120px] rounded-full py-2 2xl:py-3 md:w-[549px] w-[80%] m-auto">Next</button></Link>
                </div>
