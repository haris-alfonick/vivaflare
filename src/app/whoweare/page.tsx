...
export default function Whoweare() {
  return (
    <section className="relative scrollbar bg-[#14121B] m-3 lg:m-7 mb-0! rounded-tl-[30px] rounded-tr-[30px] 2xl:h-[calc(100vh_-_198px)] h-[calc(100vh_-_181px)] max-md:h-[calc(100vh_+_170px)]">

      <div className="grid grid-cols-12 gap-4 container mx-auto items-center align-middle absolute top-0 right-0 m-auto h-full bottom-0 left-0">

        <div className="mx-auto px-[15px] md:px-0 lg:col-span-6 col-span-12 max-2xl:[&_button]:mb-4 max-2xl:[&_h2]:pt-7 [&_h2]:font-extrabold [&_h2]:leading-[0.6] text-white [&_h2]:lg:text-[30px] [&_h2]:2xl:text-[50px] [&_h3]:text-[65px] [&_h3]:text-transparent [&_h3]:leading-none [&_h3]:2xl:text-[85px] [&_h3]:bg-gradient-to-l [&_h3]:from-[#F80C67] [&_h3]:to-[#ED1C24] [&_h3]:bg-clip-text [&_h3]:font-[600] [&_strong]:pt-[10px] md:[&_strong]:w-[407px] [&_strong]:block [&_strong]:text-[20px] 2xl:[&_strong]:text-[23px] [&_p]:w-full lg:[&_p]:w-[505px] [&_p]:pt-[9px] [&_p]:pb-[16px] [&_button]:px-12 [&_button]:transition-all [&_button]:text-white [&_button]:font-semibold [&_button]:text-sm [&_button]:py-2 [&_button]:rounded-full [&_button]:bg-[#F80C5B] [&_button]:hover:bg-gradient-to-l [&_button]:hover:from-[#ef005d] [&_button]:hover:to-[#47b4d5]">
