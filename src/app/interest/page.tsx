    ...
    return (
        <section className="scrollbar relative h-full pt-[22px] px-[25px] pb-0">
            <div className="bg-[#14121B] h-full rounded-tl-[30px] rounded-tr-[30px]">
                <div className="text-white pt-4 max-md:px-[35px] [&_h2]:mt-4 text-center absolute top-0 right-0 w-fit mx-auto m-auto h-full 2xl:h-fit bottom-0 left-0 sm:px-0 px-4 [&_h2]:2xl:text-[42px] sm:[&_h2]:w-[549px] [&_h2]:w-[100%] 2xl:[&_h2]:m-auto [&_h2]:md:text-[32px] [&_h2]:text-[25px] max-sm:[&_h2]:text-[22px] [&_h2]:font-bold [&_p]:text-center [&_p]:text-[13px] [&_p]:2xl:text-[17px]">
                    ...
                    <div className="grid grid-cols-12 pt-8 md:gap-0 gap-[12px]">
