...
export default function Interest() {
    return (
        <section className="relative bg-[#14121B] scrollbar m-3 lg:m-7 mb-0! rounded-tl-[30px] rounded-tr-[30px] 2xl:h-[calc(100vh_-_198px)] h-[calc(100vh_-_181px)] max-md:h-[calc(100vh_+_220px)]">
